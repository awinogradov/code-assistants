...
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- | --------------------------------------------------------------------- |
| `agents-rules` | `rules/<stack>.md` → `AGENTS.md`, plus `CLAUDE.md` as a symlink to it                                                                                                                    | `maintenance-sync-agents-rules` | [`agents-rules-sync`](../.github/actions/agents-rules-sync/README.md) |
