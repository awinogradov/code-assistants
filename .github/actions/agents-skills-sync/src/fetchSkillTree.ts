/**
 * Enumerates every file under the source repository's `agent-skills/` layout
 ...
 *   // → ['agent-skills/README.md', 'agent-skills/autopilot-run/SKILL.md', …]
 */
...
const layoutPrefix = 'agent-skills/';
