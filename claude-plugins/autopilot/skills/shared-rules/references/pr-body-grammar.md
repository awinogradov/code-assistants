...
- Breaking changes were detected by the [analyze-pr-commits](../../../agents/analyze-pr-commits.md#phase-3-analyze-change-significance) agent while gathering context (mandatory)
