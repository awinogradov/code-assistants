...
<!-- The six-string status vocabulary stays in sync with [resolve-issue-context.md Phase 2](https://github.com/awinogradov/code-assistants/blob/main/claude-plugins/autopilot/agents/resolve-issue-context.md#phase-2-auto-assign-current-user-opt-in); the command steps below are this file's own. -->
