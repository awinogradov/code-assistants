...
Execute the shared [**Stack Pipeline (Phases 1–6)**](../plan/SKILL.md#stack-pipeline-phases-16) defined in [`plan/SKILL.md`](../plan/SKILL.md) — Task Discovery, then [Phase 1](../plan/SKILL.md#phase-1-context-gathering) through [Phase 6](../plan/SKILL.md#phase-6-finalize-output) in order — supplying the three Bun deltas below wherever the pipeline references your stack's delta.

## Stack Deltas

**Example libraries** ([Phase 1](../plan/SKILL.md#phase-1-context-gathering), [Documentation Lookup](../plan/SKILL.md#documentation-lookup-protocol-mandatory)): `zod`, `hono`, `@effect/schema`
