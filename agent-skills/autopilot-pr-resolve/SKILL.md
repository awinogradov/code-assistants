---
name: autopilot-pr-resolve
description: >-
  Address PR review comments by analyzing feedback, making code fixes, and
  replying to reviewers. Use when resolving review feedback on a pull request.
---
...
Invoke `autopilot-commits-create`. Pass the modification list as the commit context in conversation text. Do NOT include any other context about why changes were made.
...
Invoke `autopilot-pr-update` — refreshes the PR description reflecting the new state.
